...
namespace DAL.Repositories
{
    public class FolderRepository : IFolderRepository
    {
        ...
        {
            // The cascade delete in Postgres might handle subfolders, but we might need recursive client-side delete depending on config.
            // Since EF might not load all children, recursive DB side is preferred.
